...
public class DayScheduler {
    ...
    public static String dayActivities(int day) {
        switch (day) {
            case 1 -> {
                return "Brew basic healing potions";
            }
            case 2 -> {
                return "Practice Fireball casting";
            }
            case 3 -> {
                return "Summon your sprit animal";
            }
            case 4 -> {
                return "Flying drill";
            }
            ...
            case 7 -> {
                return "Train with enchanted weapons";
            }
            default -> {
                return "Enter a valid day number (1-7)";
            }
        }
    }
}
